export default [
...

   {
     ...
     'end': new Date(2017, 9, 10, 0, 0, 0)
   },

   {
     'title': 'DTS ENDS',
     'start': new Date(2017, 9, 6, 0, 0, 0),
     'end': new Date(2017, 10, 13, 0, 0, 0)
   },

   {
     'title': 'Surgical Procedure',
     'start': new Date(2017, 9, 15, 0, 0, 0),
     'end': new Date(2017, 9, 15, 0, 0, 0)
   },
   {
     'title': 'Conference',
   ...
   {
     'title': 'Happy Hour',
     'start':new Date(2017, 9, 23, 17, 0, 0, 0),
     'end': new Date(2017, 9, 23, 17, 30, 0, 0),
