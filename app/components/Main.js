...
import HealthPlan from "./children/HealthPlan";
  	...
  	render() {
  		return(
  			<div className="hold">
  				...
  				/>
  			{this.state.initComp ? <Search getUser = {this.getUser}/> : null}
			...
			{this.state.showComp7 ? <Search getUser = {this.getUser}/> : null}



			{this.state.showSubComp2 ? <Demographics userData = {this.state.user} /> : null}
			{this.state.showSubComp3 ? <MedicalRecord userData = {this.state.user} /> : null}
			{this.state.showSubComp4 ? <Prescriptions userData = {this.state.user} /> : null}
			{this.state.showSubComp5 ? <Patient userData = {this.state.user} /> : null}
			{this.state.showSubComp10 ? <OtherHistory userData = {this.state.user} /> : null}
			{this.state.showSubComp11 ? <Pharmacies userData = {this.state.user} /> : null}
			{this.state.showSubComp12 ? <HealthPlan userData = {this.state.user} /> : null}


			{this.state.showSubComp9 ? <Vitals userData = {this.state.user}/> : null}
			{this.state.showSubComp16 ? <Tests userData = {this.state.user} /> : null}
			{this.state.showSubComp23 ? <Images userData = {this.state.user} /> : null}
